...
def hasil():
    if request.method == 'POST' :
        ...
        dataHasil={
            'female':female, 'male':male, 'child':child, 'man':man, 'woman':woman, 'pclass':pclass, 'age':age, 
            'sibsp':sibsp, 'parch':parch, 'fare':fare, 'adultman':adultman, 'alone':alone,
            'PREDIKSI' : kesimpulan
        }
    return render_template('hasiltitanic.html', hasil=dataHasil)
